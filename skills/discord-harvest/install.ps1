# Install discord-harvest skill
# Works on Windows (PowerShell 5.1+).
#
# Usage:
#   .\install.ps1           # interactive prompt
#   .\install.ps1 -Global   # install to $HOME\.claude\skills\discord-harvest
#   .\install.ps1 -Project  # install to .\.claude\skills\discord-harvest
...
function Install-Skill {
    ...
    Copy-Item (Join-Path $ScriptDir "icon.svg") $Dest
