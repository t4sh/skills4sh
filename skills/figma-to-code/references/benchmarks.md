...
| **skills4sh repo @ snapshot** | [t4sh/skills4sh](https://github.com/t4sh/skills4sh) — last commit 2026-05-16 |
...
| Last commit @ snapshot | 2026-05-16 (`t4sh/skills4sh`; skill files may be ahead on branch) |
...
| 7 | **This repo** `skills/figma-to-code/SKILL.md` | 2026-05-16 (repo); skill v0.1.1 |
