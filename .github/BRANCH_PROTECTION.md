...
Protect `main` and require pull requests to pass these **19 checks** before merge:
...
- `guardskills Scan / scan (code-to-figma, 22)`
- `guardskills Scan / scan (code-to-figma, 24)`
